  ...
  ?>
    ...
    <div class="row">
        ...
        if(count($rows)>0){
            ...
            echo "<a class='btn btn-primary btn-lg shadow-lg p-3 mb-5 rounded ' style='width: 195px;' href='donor/transactions.php' role='button'>Check Transactions</a>";
            ...
            echo "</div>";
              ...
              echo "<h2 class='shadow-lg p-3 mb-5 bg-light rounded '>Donate amount here </h2>";
              echo "</div>";
              echo " <div class='col-6'>";
  
              echo "<a class='btn btn-primary btn-lg shadow-lg p-3 mb-5 rounded ' style='width: 400px;' href='donor/details.php' role='button'>Donate</a>";
              echo "</div>";
        }
