...
?>
    ...
    <h1 class="h3 mb-3 font-weight-normal">Enter Your Details</h1>
        ...
        <p>	bank:
            <input type="text" name="bank" size="60" value="karnataka bank"/></p>
        <p>	ifsc_code:
            <input type="text" name="ifsc_code" size="60" value="KAR123"/></p>
        <p>Acount No:
            <input type="text" name="acount" size="60" value="123456789123"/></p>
        </p>
        <p>Donation:
