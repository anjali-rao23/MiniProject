  ...
  <div class = "row ">
    <div class="col-6">
      <table class="table shadow-lg p-3 mb-5 bg-light rounded ">
        ...
        <tbody class="">
           <?php 
             $stmt3 = $pdo->query("SELECT ngo_account.donor_id , donor.name ,ngo_account.donationS FROM donor JOIN ngo_account WHERE donor.donor_id = ngo_account.donor_id AND donor.city_id = 1 ");
             $rows = $stmt3->fetchAll(PDO::FETCH_ASSOC);
             $count = 1;
              foreach($rows as $row){
                echo "<tr class=''>";
                ...
                echo("<td class='' > <a class='btn btn-primary btn-sm' href='admin/delete.php?donor_id=".$row['donor_id']."'>Remove Donation</a></td>");
                echo "</tr>";
              $count++;
              }
            ?>
   ...
   <div class="col-6">
      <table class="table shadow-lg p-3 mb-5 bg-light rounded ">
        ...
        <tbody class="">
           <?php 
             $stmt3 = $pdo->query("SELECT ngo_account.donor_id , donor.name ,ngo_account.donationS FROM donor JOIN ngo_account WHERE donor.donor_id = ngo_account.donor_id AND donor.city_id = 2");
             $rows = $stmt3->fetchAll(PDO::FETCH_ASSOC);
             $count = 1;
              foreach($rows as $row){
                echo "<tr class=''>";
   ...
   <div class = "row">
    <div class="col-6">
      <table class="table shadow-lg p-3 mb-5 bg-light rounded ">
        ...
        <tbody class="">
           <?php 
             $stmt3 = $pdo->query("SELECT ngo_account.donor_id , donor.name ,ngo_account.donationS FROM donor JOIN ngo_account WHERE donor.donor_id = ngo_account.donor_id AND donor.city_id =  3");
             $rows = $stmt3->fetchAll(PDO::FETCH_ASSOC);
             $count = 1;
              foreach($rows as $row){
                echo "<tr class=''>";
   ...
   <div class="col-6">
      <table class="table shadow-lg p-3 mb-5 bg-light rounded ">
        ...
        <tbody class="">
           <?php 
             $stmt3 = $pdo->query("SELECT ngo_account.donor_id , donor.name ,ngo_account.donationS FROM donor JOIN ngo_account WHERE donor.donor_id = ngo_account.donor_id AND donor.city_id =  4");
             $rows = $stmt3->fetchAll(PDO::FETCH_ASSOC);
             $count = 1;
              foreach($rows as $row){
                echo "<tr class=''>";
